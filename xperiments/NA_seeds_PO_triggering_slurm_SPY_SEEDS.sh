...
if [ $1 == "NA_1" ] || [ $1 == "NA_2" ] || [ $1 == "NA_1_2det" ] || [ $1 == "NA_2_2det" ]; then
    ...
    echo "srun NA_seeds_PO_loops_slurm_SPY_SEEDS.sh ${ALGO} ${my_array1[$(($THREAD))]}  ${PROBLEMS} ${DATASET} "${MAHABSET}" ${my_array2[$(($THREAD))]}  ${my_array3[$(($THREAD))]} ${my_array4[$(($THREAD))]} ${my_array5[$(($THREAD))]} ${my_array6[$(($THREAD))]} ${my_array7[$(($THREAD))]} ${my_array8[$(($THREAD))]} ${my_array9[$(($THREAD))]} ${my_array10[$(($THREAD))]} ${2}"
    ...
    srun NA_seeds_PO_loops_slurm_SPY_SEEDS.sh ${ALGO} ${my_array1[$(($THREAD))]}  ${PROBLEMS} ${DATASET} "${MAHABSET}" ${my_array2[$(($THREAD))]}  ${my_array3[$(($THREAD))]} "${my_array4[$(($THREAD))]}" "${my_array5[$(($THREAD))]}" "${my_array6[$(($THREAD))]}" ${my_array7[$(($THREAD))]} ${my_array8[$(($THREAD))]} ${my_array9[$(($THREAD))]} ${my_array10[$(($THREAD))]} ${2}
    # fi
elif [ $1 == "CPF" ]; then
    # Create the job
    ...
    echo "========= TASK ID: ${SLURM_ARRAY_TASK_ID} ========="
    echo "./run_PO_competitors_and_run_base_SPY_SEEDS.sh ${ALGO} ${2} ${PROBLEMS} ${DATASET} ${MAHABSET} ${CPF_ms_array1[$(($SLURM_ARRAY_TASK_ID))]} ${CPF_driftDets_array3[$(($SLURM_ARRAY_TASK_ID))]} ${CPF_base_array4[$(($SLURM_ARRAY_TASK_ID))]}"
    echo "--------------------------"
    ...
    srun run_PO_competitors_and_run_base_SPY_SEEDS.sh ${ALGO} ${2} ${PROBLEMS} ${DATASET} ${MAHABSET} ${CPF_ms_array1[$(($SLURM_ARRAY_TASK_ID))]} ${CPF_driftDets_array3[$(($SLURM_ARRAY_TASK_ID))]} ${CPF_base_array4[$(($SLURM_ARRAY_TASK_ID))]}
    ...
    echo "========= TASK ID: ${SLURM_ARRAY_TASK_ID} ========="
    echo "./run_parameter_optimization_COMPETITORS_SPY_SEEDS.sh ${ALGO} ${2} ${PROBLEMS} ${DATASET} ${MAHABSET} ${RCD_driftDets[$(($SLURM_ARRAY_TASK_ID%5))]} ${RCD_bs[$(($SLURM_ARRAY_TASK_ID%5))]}"
    echo "--------------------------"
    srun run_parameter_optimization_COMPETITORS_SPY_SEEDS.sh ${ALGO} ${2} ${PROBLEMS} ${DATASET} ${MAHABSET} ${RCD_driftDets[$(($SLURM_ARRAY_TASK_ID%5))]} ${RCD_bs[$(($SLURM_ARRAY_TASK_ID%5))]}
    ...
    echo "========= TASK ID: ${SLURM_ARRAY_TASK_ID} ========="
    echo "./run_parameter_optimization_COMPETITORS_SPY_SEEDS.sh ${ALGO} ${2} ${PROBLEMS} ${DATASET} ${MAHABSET} ${DWM_thetas[$(($SLURM_ARRAY_TASK_ID%4))]} ${DWM_periods[$(($SLURM_ARRAY_TASK_ID%5))]}"
    echo "--------------------------"
    srun run_parameter_optimization_COMPETITORS_SPY_SEEDS.sh ${ALGO} ${2} ${PROBLEMS} ${DATASET} ${MAHABSET} ${DWM_thetas[$(($SLURM_ARRAY_TASK_ID%4))]} ${DWM_periods[$(($SLURM_ARRAY_TASK_ID%5))]}
    ...
    echo "========= TASK ID: ${SLURM_ARRAY_TASK_ID} ========="
    echo "./run_parameter_optimization_COMPETITORS_SPY_SEEDS.sh ${ALGO} ${2} ${PROBLEMS} ${DATASET} ${MAHABSET} ${LNSE_sigSlopes[$(($SLURM_ARRAY_TASK_ID%4))]} ${LNSE_periods[$(($SLURM_ARRAY_TASK_ID%6))]} "
    echo "--------------------------"
    srun run_parameter_optimization_COMPETITORS_SPY_SEEDS.sh ${ALGO} ${2} ${PROBLEMS} ${DATASET} ${MAHABSET} ${LNSE_sigSlopes[$(($SLURM_ARRAY_TASK_ID%4))]} ${LNSE_periods[$(($SLURM_ARRAY_TASK_ID%6))]}
else
    # Create the job
    ARGS=("ARF" "AUE" "base")
    echo "========= TASK ID: ${SLURM_ARRAY_TASK_ID} ========="
    echo "./run_PO_competitors_and_run_base_SPY_SEEDS.sh ${ARGS[${SLURM_ARRAY_TASK_ID}]} ${2} ${PROBLEMS} ${DATASET} ${MAHABSET}"
    echo "--------------------------"
    srun run_PO_competitors_and_run_base_SPY_SEEDS.sh ${ARGS[${SLURM_ARRAY_TASK_ID}]} ${2} ${PROBLEMS} ${DATASET} ${MAHABSET}
