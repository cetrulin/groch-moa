...
for PROBLEM in $PROBLEMS; do
          ...
          # for NA_driftDet in $NA_driftDets; do
            ...
            # IMP: APPLY LAST PARAMS HERE FOR ADDM TOO (ONLY DONE FOR EDDM TILL NOW...)
                for NA_drift_adwin_confidence in $NA_drift_adwin_confidences; do
                  ...
                  if [ $1 == "NA_1" ]; then
                    NA="meta.NA -l (${NA_baseClassifier}) ${forceEarlyDrifts} ${alwaysTransitToBlankClassifAtEarlyDrift} ${instanceThreshForInsertions} ${trainOnWarn} ${trainEND} ${preTrain} -w ${wwMinThresh} -I ${minInstTrainedForInsertion} -D 1 -z 1 -k ${NA_feature_subset_indexes1} -M ${NA_groupMaxSize} -t ${NA_distanceThresh} -c (GNG -l ${gng_lambda} -m ${gng_maxAge} -c 2147483647 -b) -o ${DATAPATH}/${PROBLEM}/${mahalanobis_init_set} -d (${driftDetection})"
                    ALGORITHM=${NA}                                                                                                                        
                    ALGOTOK=$(echo "NA_HT_${NA_groupMaxSize}_1_${NA_distanceThresh}_${gng_lambda}_${gng_maxAge}_${driftDetectionAlgo}-${NA_drift_adwin_confidence}_${trainOnWarn}_${trainEND}_${preTrain}_${wwMinThresh}_${minInstTrainedForInsertion}_${forceEarlyDrifts}_${alwaysTransitToBlankClassifAtEarlyDrift}_${instanceThreshForInsertions}" | sed 's/ //g')
                    # #
                    # FILE=${ALGOTOK}.txt
                    # if [ -f "$FILE" ]; then
                  ...
                  if [ $1 == "NA_2" ]; then
                    NA="meta.NA -l (${NA_baseClassifier}) ${forceEarlyDrifts} ${alwaysTransitToBlankClassifAtEarlyDrift} ${instanceThreshForInsertions} ${trainOnWarn} ${trainEND} ${preTrain} -w ${wwMinThresh} -I ${minInstTrainedForInsertion} -D 1 -z 1 -k ${NA_feature_subset_indexes2} -M ${NA_groupMaxSize} -t ${NA_distanceThresh} -c (GNG -l ${gng_lambda} -m ${gng_maxAge} -c 2147483647 -b) -o ${DATAPATH}/${PROBLEM}/${mahalanobis_init_set} -d (${driftDetection})"
                    ALGORITHM=${NA}
                    echo "***************"
                    echo ${DATASET}
                    echo ${mahalanobis_init_set}
                    ...
                    echo ${NA}
                    echo "***************"
                    ALGOTOK=$(echo "NA_HT_${NA_groupMaxSize}_2_${NA_distanceThresh}_${gng_lambda}_${gng_maxAge}_${driftDetectionAlgo}-${NA_drift_adwin_confidence}_${trainOnWarn}_${trainEND}_${preTrain}_${wwMinThresh}_${minInstTrainedForInsertion}_${forceEarlyDrifts}_${alwaysTransitToBlankClassifAtEarlyDrift}_${instanceThreshForInsertions}" | sed 's/ //g')
                    ${evaluation}
                    ${evaluation}Window 
                  fi
                done
                ...
                if [ "${NA_driftDet}" == "RDDM" ]; then
                  for RDDM_confidence in $NA_RDDM_confidences; do
                    ...
                    if [ $1 == "NA_1" ]; then
                      ...
                      echo ${NA}
                      echo "***************"
                      ALGOTOK=$(echo "NA_HT_${NA_groupMaxSize}_1_${NA_distanceThresh}_${gng_lambda}_${gng_maxAge}_${driftDetectionAlgo}-${RDDM_confidence}_${trainOnWarn}_${trainEND}_${preTrain}_${wwMinThresh}_${minInstTrainedForInsertion}_${forceEarlyDrifts}_${alwaysTransitToBlankClassifAtEarlyDrift}_${instanceThreshForInsertions}" | sed 's/ //g')
                      ${evaluation}
                      ${evaluation}Window 
                    fi
                    if [ $1 == "NA_2" ]; then
                      ...
                      echo ${NA}
                      echo "***************"
                      ALGOTOK=$(echo "NA_HT_${NA_groupMaxSize}_2_${NA_distanceThresh}_${gng_lambda}_${gng_maxAge}_${driftDetectionAlgo}-${RDDM_confidence}_${trainOnWarn}_${trainEND}_${preTrain}_${wwMinThresh}_${minInstTrainedForInsertion}_${forceEarlyDrifts}_${alwaysTransitToBlankClassifAtEarlyDrift}_${instanceThreshForInsertions}" | sed 's/ //g')
                      ${evaluation}
                      ${evaluation}Window 
                    fi
                    # end of block
                  ...
                  if [ $1 == "NA_1" ]; then 
                    ...
                    echo ${NA}
                    echo "***************"
                    ALGOTOK=$(echo "NA_HT_${NA_groupMaxSize}_1_${NA_distanceThresh}_${gng_lambda}_${gng_maxAge}_${driftDetectionAlgo}_${trainOnWarn}_${trainEND}_${preTrain}_${wwMinThresh}_${minInstTrainedForInsertion}_${forceEarlyDrifts}_${alwaysTransitToBlankClassifAtEarlyDrift}_${instanceThreshForInsertions}" | sed 's/ //g')
                    ${evaluation}
                    ${evaluation}Window 
                  fi
                  if [ $1 == "NA_2" ]; then
                    ...
                    echo ${NA}
                    echo "***************"
                    ALGOTOK=$(echo "NA_HT_${NA_groupMaxSize}_2_${NA_distanceThresh}_${gng_lambda}_${gng_maxAge}_${driftDetectionAlgo}_${trainOnWarn}_${trainEND}_${preTrain}_${wwMinThresh}_${minInstTrainedForInsertion}_${forceEarlyDrifts}_${alwaysTransitToBlankClassifAtEarlyDrift}_${instanceThreshForInsertions}" | sed 's/ //g')
                    ${evaluation}
                    ${evaluation}Window 
                  fi
                  # end of block
  ...
  #                   ALGORITHM=${NA}
  #                   ALGOTOK="NAold_HT_${NA_groupMaxSize}_1_${NA_distanceThresh}_${gng_lambda}_${gng_maxAge}_${NA_driftDet}_${NA_drift_adwin_confidence}"
  #                   echo "***************"
  #                   echo ${NA}
  #                   echo "***************"
  #                   ${evaluation}
  ...
  #                   echo ${NA}
  #                   echo "***************"
  #                   ALGOTOK="NAold_HT_${NA_groupMaxSize}_2_${NA_distanceThresh}_${gng_lambda}_${gng_maxAge}_${NA_driftDet}_${NA_drift_adwin_confidence}"
  #                   ${evaluation}
  #                   ${evaluation}Window 
  #                 fi
  #               done
  ...
  #                     echo ${NA}
  #                     echo "***************"
  #                     ALGOTOK="NAold_HT_${NA_groupMaxSize}_1_${NA_distanceThresh}_${gng_lambda}_${gng_maxAge}_${NA_driftDet}-${RDDM_confidence}"
  #                     ${evaluation}
  #                     ${evaluation}Window 
  #                   fi
  #                   if [ $1 == "NA_2_2det" ]; then
  ...
  #                     echo ${NA}
  #                     echo "***************"
  #                     ALGOTOK="NA_HT_${NA_groupMaxSize}_2_${NA_distanceThresh}_${gng_lambda}_${gng_maxAge}_${NA_driftDet}-${RDDM_confidence}"
  #                     ${evaluation}
  #                     ${evaluation}Window 
  #                   fi
  #                   # end of block
  ...
  #                   echo ${NA}
  #                   echo "***************"
  #                   ALGOTOK="NAold_HT_${NA_groupMaxSize}_1_${NA_distanceThresh}_${gng_lambda}_${gng_maxAge}_${NA_driftDet}"
  #                   ${evaluation}
  #                   ${evaluation}Window 
  #                 fi
  #                 if [ $1 == "NA_2_2det" ]; then
  ...
  #                   echo ${NA}
  #                   echo "***************"
  #                   ALGOTOK="NAold_HT_${NA_groupMaxSize}_2_${NA_distanceThresh}_${gng_lambda}_${gng_maxAge}_${NA_driftDet}"
  #                   ${evaluation}
  #                   ${evaluation}Window 
  #                 fi
  #                 # end of block
  ...
  # CPF_driftDets="DDM EDDM ADWINChangeDetector RDDM HDDM_A_Test"
  CPF_driftDets="EDDM"
  CPF_fadeModelss=("-f" "")
          ...
          if [ "${CPF_driftDet}" == "ADWINChangeDetector" ]; then
            for CPF_drift_adwin_confidence in $CPF_drift_adwin_confidences; do
              ...
              # for CPF_min_buffer_size in $CPF_min_buffer_sizes; do
                ...
                ALGORITHM=${CPF}
                ALGOTOK="CPF_HT_${CPF_fadeModels}_${CPF_f}_${CPF_m}_${CPF_min_buffer_size}_${CPF_driftDet}_${CPF_drift_adwin_confidence}"
                ${evaluation}
                ${evaluation}Window 
              # done
              ECPF="meta.ECPF -l ${CPF_baseClassifier} ${CPF_fadeModels} -p ${CPF_f} -d (${driftDetection}) -m ${CPF_m} -c 1" 
              ALGORITHM=${ECPF}
              ALGOTOK="ECPF_HT_${CPF_fadeModels}_${CPF_f}_${CPF_m}_${CPF_driftDet}_${CPF_drift_adwin_confidence}"
              ${evaluation}
              ${evaluation}Window 
            done
          else
              ...
              # for CPF_min_buffer_size in $CPF_min_buffer_sizes; do
                CPF="meta.CPF -l ${CPF_baseClassifier} ${CPF_fadeModels} -p ${CPF_f} -d (${driftDetection}) -m ${CPF_m} -b ${CPF_min_buffer_size}"
                ALGORITHM=${CPF}
                ALGOTOK="CPF_HT_${CPF_fadeModels}_${CPF_f}_${CPF_m}_${CPF_min_buffer_size}_${CPF_driftDet}"
                ${evaluation}
                ${evaluation}Window 
              # done
              ECPF="meta.ECPF -l ${CPF_baseClassifier} ${CPF_fadeModels} -p ${CPF_f} -d (${driftDetection}) -m ${CPF_m} -c 1" 
              ALGORITHM=${ECPF}
              ALGOTOK="ECPF_HT_${CPF_fadeModels}_${CPF_f}_${CPF_m}_${CPF_driftDet}"
              ${evaluation}
              ${evaluation}Window 
          fi
        done
              ...
              # for RCD_driftDet in $RCD_driftDets; do
                if [ "${RCD_driftDet}" == "ADWINChangeDetector" ]; then
                    for RCD_drift_adwin_confidence in $RCD_drift_adwin_confidences; do
                      ...
                      echo ${RCD}
                      echo "***************"
                      ALGOTOK="RCD_HT_${RCD_c}_${RCD_k}_${RCD_s}_${RCD_b}_${RCD_t}_${RCD_driftDet}_${RCD_drift_adwin_confidence}"
                      ${evaluation}
                      ${evaluation}Window 
                    done
                else
                    ...
                    RCD="meta.RCD -c ${RCD_c} -l ${RCD_baseClassifier} -a (KNN -k ${RCD_k}) -s ${RCD_s} -b ${RCD_b} -t ${RCD_t} -d ${driftDetection}" # (1 tree)
                    ALGORITHM=${RCD}
                    ALGOTOK="RCD_HT_${RCD_c}_${RCD_k}_${RCD_s}_${RCD_b}_${RCD_t}_${RCD_driftDet}"
                    ${evaluation}
                    ${evaluation}Window 
                fi
              # done
  ...
  for AUE_chunksize in $AUE_chunksizes; do
    for AUE_n_members in $AUE_n_memberss; do
      ...
      ALGORITHM=${AUE}
      ALGOTOK="AUE_HT_${AUE_n_members}_${AUE_chunksize}"
      ${evaluation}
      ${evaluation}Window 
    done
  done
      ...
      for DWM_beta in $DWM_betas; do
        # for DWM_theta in $DWM_thetas; do
          for DWM_maxExperts in $DWM_maxExpertss; do
            ...
            ALGORITHM=${DWM}
            ALGOTOK="DWM_HT_${DWM_maxExperts}_${DWM_period}_${DWM_beta}_${DWM_theta}"
            ${evaluation}
            ${evaluation}Window 
          done
        # done
  ...
  #             ALGORITHM=${LearnNSE}
  #             ALGOTOK="LNSE_HT_${LNSE_ensemble_size}_${LNSE_period}_${LNSE_sigSlope}_${LNSE_sigCrossPoint}"
  #             ${evaluation}
  #             ${evaluation}Window 
  #           done
  #         # done
