...
echo "srun ${MOA_DEV}/experiments/scripts/run_spy_tests_May2021_eddm.sh ${1} ${2} ${SLURM_ARRAY_TASK_ID} ${3} ${4} ${lines[0]} ${lines[1]} ${lines[2]} ${lines[3]} ${lines[4]}"
echo "--------------------------"
srun $MOA_DEV/experiments/scripts/run_spy_tests_May2021_eddm.sh ${1} ${2} ${SLURM_ARRAY_TASK_ID} ${3} ${4} ${lines[0]} ${lines[1]} ${lines[2]} ${lines[3]} ${lines[4]}
