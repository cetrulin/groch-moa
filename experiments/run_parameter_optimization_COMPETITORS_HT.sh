            ...
            if [ "${NA_driftDet}" == "ADDM" ]; then
                for NA_drift_adwin_confidence in $NA_drift_adwin_confidences; do
                  ...
                  if [ $1 == "NA_1" ]; then
                    ...
                    ALGORITHM=${NA}
                    ALGOTOK="NA_HT_${NA_groupMaxSize}_1_${NA_distanceThresh}_${gng_lambda}_${gng_maxAge}_${NA_driftDet}_${NA_drift_adwin_confidence}"
                    # #
                    # FILE=${ALGOTOK}.txt
                    # if [ -f "$FILE" ]; then
                  ...
                  if [ $1 == "NA_2" ]; then
                    ...
                    echo ${NA}
                    echo "***************"
                    ALGOTOK="NA_HT_${NA_groupMaxSize}_2_${NA_distanceThresh}_${gng_lambda}_${gng_maxAge}_${NA_driftDet}_${NA_drift_adwin_confidence}"
                    ${evaluation}
                    ${evaluation}Window 
                  fi
                done
                ...
                if [ "${NA_driftDet}" == "RDDM" ]; then
                  for RDDM_confidence in $NA_RDDM_confidences; do
                    ...
                    if [ $1 == "NA_1" ]; then
                      ...
                      echo ${NA}
                      echo "***************"
                      ALGOTOK="NA_HT_${NA_groupMaxSize}_1_${NA_distanceThresh}_${gng_lambda}_${gng_maxAge}_${NA_driftDet}-${RDDM_confidence}"
                      ${evaluation}
                      ${evaluation}Window 
                    fi
                    if [ $1 == "NA_2" ]; then
                  ...
                  if [ $1 == "NA_1" ]; then
                    ...
                    echo ${NA}
                    echo "***************"
                    ALGOTOK="NA_HT_${NA_groupMaxSize}_1_${NA_distanceThresh}_${gng_lambda}_${gng_maxAge}_${NA_driftDet}"
                    ${evaluation}
                    ${evaluation}Window 
                  fi
                  if [ $1 == "NA_2" ]; then
                    ...
                    echo ${NA}
                    echo "***************"
                    ALGOTOK="NA_HT_${NA_groupMaxSize}_2_${NA_distanceThresh}_${gng_lambda}_${gng_maxAge}_${NA_driftDet}"
                    ${evaluation}
                    ${evaluation}Window 
                  fi
                  # end of block
