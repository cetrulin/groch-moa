...
maraw=""
MAHABSET="${DATASETPATH}/spy10yr_mahalanobis_state_1.arff;${DATASETPATH}/spy10yr_mahalanobis_state_2.arff;${DATASETPATH}/spy10yr_mahalanobis_state_3.arff"
...
if [ $SEED == "5m" ]; then
    ...
    if [ $4 == "NB" ]; then
        ...
        if [ $1 == "NA" ]; then
            ...
            CPF_driftDet="RDDM -o 2.2 -w 1.23"
            CPF_m="0.99"
            CPF_f="4"
            CPF_min_buffer_size="60"
            CPF_fadeModels=""
