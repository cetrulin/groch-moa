...
if [ $1 == "NA_1" ] || [ $1 == "NA_2" ] || [ $1 == "NA_1_2det" ] || [ $1 == "NA_2_2det" ]; then
    ...
    echo "srun NA_seeds_PO_loops_slurm.sh ${ALGO} ${my_array1[$(($THREAD))]}  ${PROBLEMS} ${DATASET} "${MAHABSET}" ${my_array2[$(($THREAD))]}  ${my_array3[$(($THREAD))]} ${my_array4[$(($THREAD))]} ${my_array5[$(($THREAD))]} ${my_array6[$(($THREAD))]} ${my_array7[$(($THREAD))]} ${my_array8[$(($THREAD))]} ${my_array9[$(($THREAD))]} ${my_array10[$(($THREAD))]} ${2}"
    ...
    srun NA_seeds_PO_loops_slurm.sh ${ALGO} ${my_array1[$(($THREAD))]}  ${PROBLEMS} ${DATASET} "${MAHABSET}" ${my_array2[$(($THREAD))]}  ${my_array3[$(($THREAD))]} "${my_array4[$(($THREAD))]}" "${my_array5[$(($THREAD))]}" "${my_array6[$(($THREAD))]}" ${my_array7[$(($THREAD))]} ${my_array8[$(($THREAD))]} ${my_array9[$(($THREAD))]} ${my_array10[$(($THREAD))]} ${2}
elif [ $1 == "CPF" ]; then
    # Create the job
    ...
    echo "========= TASK ID: ${SLURM_ARRAY_TASK_ID} ========="
    echo "./run_PO_competitors_and_run_base.sh ${ALGO} ${2} ${PROBLEMS} ${DATASET} ${MAHABSET} ${CPF_ms_array1[$(($SLURM_ARRAY_TASK_ID))]} ${CPF_driftDets_array3[$(($SLURM_ARRAY_TASK_ID))]} ${CPF_base_array4[$(($SLURM_ARRAY_TASK_ID))]}"
    echo "--------------------------"
    ...
    srun run_PO_competitors_and_run_base.sh ${ALGO} ${2} ${PROBLEMS} ${DATASET} ${MAHABSET} ${CPF_ms_array1[$(($SLURM_ARRAY_TASK_ID))]} ${CPF_driftDets_array3[$(($SLURM_ARRAY_TASK_ID))]} ${CPF_base_array4[$(($SLURM_ARRAY_TASK_ID))]}
    ...
    ARGS=("ARF" "AUE" "base")
    echo "========= TASK ID: ${SLURM_ARRAY_TASK_ID} ========="
    echo "./run_PO_competitors_and_run_base.sh ${ARGS[${SLURM_ARRAY_TASK_ID}]} ${2} ${PROBLEMS} ${DATASET} ${MAHABSET}"
    echo "--------------------------"
    srun run_PO_competitors_and_run_base.sh ${ARGS[${SLURM_ARRAY_TASK_ID}]} ${2} ${PROBLEMS} ${DATASET} ${MAHABSET}
